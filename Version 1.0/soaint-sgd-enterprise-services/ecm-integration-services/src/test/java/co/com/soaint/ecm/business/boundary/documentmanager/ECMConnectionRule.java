...
public class ECMConnectionRule implements TestRule {
            ...
            public void evaluate() throws Throwable {
                ...
                try {
                    ...
                    unidadDocumentalDTOList.forEach(doc -> {
                        try {
                            contentControlAlfresco.eliminarUnidadDocumental(doc.getId());
                        } catch (Exception e) {
    ...
    public MensajeRespuesta uploadNewDocument(String nombreDocumento) throws SystemException {
        ...
        return contentControlAlfresco.subirDocumentoPrincipalAdjunto(doc, "EE");
    }

    public DocumentoDTO existingDocumento(String nombre) throws SystemException {
        DocumentoDTO doc = newDocumento(nombre);
        MensajeRespuesta mensajeRespuesta = contentControlAlfresco.subirDocumentoPrincipalAdjunto(doc, "EE");
