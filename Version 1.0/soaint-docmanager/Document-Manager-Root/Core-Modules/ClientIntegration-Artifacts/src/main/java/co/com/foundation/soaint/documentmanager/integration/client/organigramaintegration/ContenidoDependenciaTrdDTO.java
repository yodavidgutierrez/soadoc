 ...
 *         &lt;element name="listaDependencia" type="{http://co.com.soaint.sgd.correspondencia.service}organigramaDTO" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="listaSede" type="{http://co.com.soaint.sgd.correspondencia.service}sedeDTO" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="listaSerie" type="{http://co.com.soaint.sgd.correspondencia.service}serieDTO" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="listaSubSerie" type="{http://co.com.soaint.sgd.correspondencia.service}subSerieDTO" maxOccurs="unbounded" minOccurs="0"/>
